        ...
        <form method="POST" action="index.php?act=sanpham&type=addsp" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="ten_sp" value="<?= $ten_sp ?>">
                </div>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="" name="gia_sp" value="<?= $gia_sp ?>">
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputEmail1" placeholder="" name="ngaynhap_sp" value="<?= date('d/m/Y', strtotime($ngaynhap_sp)) ?>">
                </div>
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" id="exampleSelectRounded0" name="trangthai_sp">
                        <option value="<?= $trangthai_sp ?>">Kinh doanh</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <br>
                    <div>
                        <img src="./../../../public/img/<?= $anh_sp ?>" alt="" width="100px" id="anhHienThi">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" placeholder="" name="mota_sp" value="<?= $mota_sp ?>"></textarea>
                </div>
            </div>
            <!-- /.card-body -->
